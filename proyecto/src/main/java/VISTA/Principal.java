...
public class Principal implements Initializable{
    ...
    public void openViewInsertPenalty(ActionEvent actionEvent) {
        openModalWidow("/InsertPenalty.fxml", "No se ha podido acceder a la Inserción de Multas ");

    }

    public void openViewListOfPenalties(ActionEvent actionEvent) {
        openModalWidow("/ListOfPenalties.fxml", "No se ha podido acceder a La lista de multas");
    }

    public void openViewDataPolice(ActionEvent actionEvent) {
        openModalWidow("/DataPolice.fxml", "No se ha podido acceder a los datos policiales ");
    }
